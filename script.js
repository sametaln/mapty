...
class App {
    ...
    // Getting position of the user on the map
    _getPosition() {
    ...
    _loadMap(position) {
        ...
        // Render the markers from local storage
    ...
    _moveToPopup(e) {
        ...
        const workoutID = this.#workouts.find(work => work.id === workoutEl.dataset.id)
 ...
 * Display weather data for workout time and place (ASYNC)
*/
